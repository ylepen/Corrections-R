...
On importe les données trimestrielles du PIB des Etats-Unis du 01/01/1947 au 23/01/01 (305 observations). Les données sont importées du site db.nomics. Les données proviennent du \`\`Bureau of Labor Statistics''. On leur importe en utilisant leur identifiant ids.
